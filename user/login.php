...
<div class="loginOrRegister font">
    <ul id="myTabs" class="nav nav-tabs padding25">
    ...
    <div id="reg" class="display-none">
        <form method="post" action="dealUserRegister.php">
            <div class="list-group-item border-top-none">
                <input type="text" class="form-control" name="username" placeholder="账户名">
            </div>
            ...
            <div class="list-group-item">
                <div class="input-group">
                    ...
                    <input type="text" class="form-cSontrol" aria-describedby="basic-addon1" name="verify">
                </div>
            </div>
            <br/>
    ...
    <div id="login">
        <form method="post" action="dealUserLogin.php">
            <div class="list-group-item border-top-none">
